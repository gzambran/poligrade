...
export default function FAQPage() {
  const faqData = [
    ...
    {
      question: 'How does PoliGrade determine which candidates receive profiles?',
      answer: 'PoliGrade evaluates several factors when deciding which candidates to profile and grade. We consider whether candidates have filed official candidacy papers, demonstrated meaningful fundraising through FEC filings, achieved realistic polling numbers, and maintained active campaign websites. These criteria help us assess whether a candidate has a viable path to receiving a significant share of votes. We recognize that some may disagree with this approach, but our mission is to help voters make informed decisions—and part of that means distinguishing between candidates with a real chance of winning and those without. Focusing on viable candidates also allows us to manage our resources effectively as we scale to over a thousand profiles, ensuring PoliGrade remains a reliable and accessible resource for our users.',
    },
    {
